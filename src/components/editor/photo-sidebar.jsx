...
export function PhotoSidebar({
  ...
  return (
    <aside className="relative flex h-full min-h-0 w-full shrink-0 flex-col border-b border-white/10 bg-[rgba(6,11,24,0.75)] backdrop-blur-2xl xl:max-w-[380px] xl:border-b-0 xl:border-r">
      ...
      <div className="flex items-start justify-between gap-4 px-4 pb-5 pt-5 sm:px-6 sm:pt-6">
        <div className="min-w-0">
          <Badge variant="accent" className="mb-3">atelier local</Badge>
        ...
        <div className="space-y-4">
          ...
          <Card>
            ...
            <CardContent className="space-y-3">
              ...
              <input ref={folderInputRef} type="file" webkitdirectory="true" directory="" multiple className="hidden" onChange={onFolderSelection} />
                        ...
                        >
                          ...
                          {photo.points.length === 4 ? (
                            <div className="absolute right-2 top-2 rounded-full border border-white/10 bg-black/60 p-1 backdrop-blur">
                              <Check className={`h-3.5 w-3.5 ${photo.saved ? "text-cyan-200" : "text-emerald-300"}`} />
                            </div>
                          ) : null}
                          <button
                            type="button"
